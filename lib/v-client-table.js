...
exports.install = function(Vue, globalOptions) {
  ...
  methods: {
    ...
    getQueriableColumns: function() {
      ...
      var queriable =  this.allColumns.filter(function(n) {
          return this.options.columns.indexOf(n) != -1
      }.bind(this));

      return queriable.length?queriable:this.allColumns;
