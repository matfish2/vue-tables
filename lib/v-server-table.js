      ...
      this.defaults = $.extend(true, this.defaults, globalOptions);
			...
			this.getData().done(function(data) {
      				...
      				this.query = this.initQuery(this.columns);
							...
							this.extras = this.templatesKeys.diff(this.columns);
